...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="images/3s.png" class="d-block w-100" alt="Banner 1">
        </div>
</div>
<br>
...
<div class="text-center">
        <p class="mt-2">Discover our handpicked range of blushes, designed to add a natural glow and a touch of elegance to every look.</p>
    </div>
...
<div class="container mt-5">
    <div class="row align-items-center">
        <!-- Text on the Left -->
        <div class="col-md-6">
            <h2 class="text-left" style="font-family: 'Sorts Mill Goudy', serif; text-align: center; color: #A55548;"
>Find Your Perfect Beauty Matches</h2>
            <p class="text-left">
				   ...
				   <div class="text-left">
    <button type="button" class="buttonquiz" onclick="window.location.href='FindMyShade1s.php'">Take Quiz</button>
</div>
	<br>
        </div>
        <!-- Image on the Right -->
