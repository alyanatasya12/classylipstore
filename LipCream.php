...
<div class="text-center">
        <h1 class="liptext">Lip Cream</h1>
        <p class="lipdesc">Unleash the magic of our Lip Cream, where bold pigments meet a luscious, lightweight texture. Glide into silky smooth perfection that keeps your lips soft, vibrant, and irresistible all day long.</p>
    </div>
	    </div>
<br>
    <!-- Cards Section -->
