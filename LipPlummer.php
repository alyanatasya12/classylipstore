...
// Subcategory ID (set explicitly to 6)
$subcategoryId = 6;
...
<div class="text-center">
        <h1 class="liptext">Lip Plummer</h1>
        <p class="lipdesc">Transform your lips with our glossy lip plumpers, designed to enhance volume and shine for a bold, irresistible look.</p>
    </div>
	    </div>
