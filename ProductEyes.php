...
if (!empty($shades)) {
    $shadeIds = implode(',', array_keys($shades)); 
    $imageQuery = "
...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="images/2s.png" class="d-block w-100" alt="Banner 1">
        </div>
...
<div class="text-center">
   <p class="mt-2">Explore our curated collection of eyeshadow palettes, perfect for every occasion and style.</p>
    </div>
...
<div class="container mt-5">
    <div class="row align-items-center">
        <!-- Text on the Left -->
        <div class="col-md-6">
            <h2 class="text-left" style="font-family: 'Sorts Mill Goudy', serif; text-align: center;">Find Your Perfect Beauty Matches</h2>
            <p class="text-left">
	...
	<br>
        ...
        <!-- Image on the Right -->
        <div class="col-md-6">
            <img src="images/7.png" alt="Lip Plummer" class="img-fluid">
        </div>
    <br>
</div>
</div>
...
<!-- Subscribe Section --> 
<div class= "emailtext" > 
<h1 class="text-center" style="font-family: 'Sorts Mill Goudy', serif; text-align: center; color: #A55548;"
>KEEP IN TOUCH</h1> 
